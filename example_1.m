...
% 8 trajectory
sx = @(t) (0.9 .* sin(2*pi*f*t)); % m
sy = @(t) (0.9 .* sin(2*pi*f*t)*cos(2*pi*f*t)); % m
sz = @(t) (0.0 .* cos(2*pi*f*3*t)); % m
...
[s, vRef, aRef, phi_t] = my_lin(s,"sym",t);
...
%% plot
trajectory_tool.linear(t,s,phi,vRef,aB);
